...
// Package parser_testcases provides shared short parser test programs.
package parser_testcases

import "slices"

// Valids returns a copy of the short valid parser test programs.
func Valids() []string {
	return slices.Clone(valids)
}

// Invalids returns a copy of the short invalid parser test programs.
func Invalids() []string {
	return slices.Clone(invalids)
}
